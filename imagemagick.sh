...
convert yellow-red-orange-cyan-blue.png sphinx-theme/${BACKGROUNDIMAGE} -composite hero-yellow-red-orange-cyan-blue.png
...
#convert title-caption-presenter-position-version.png sphinx-theme/${LOGO} -gravity northeast -geometry 130x130+110+110 -composite intro.png
convert title-caption-presenter-position-version.png sphinx-theme/${LOGO} -gravity northwest -geometry 95x95+75+75 -composite intro.png
convert yellow-red-orange-cyan-blue.png sphinx-theme/${LOGO} -gravity center -geometry 380x380-0-19 -composite outro.png
